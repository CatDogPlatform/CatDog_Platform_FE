...
import { Button, TextField, Typography, createTheme, Snackbar, Alert } from "@mui/material";
...
function UpdateProfileForm({ onClose }) {
    ...
    const formik = useFormik({
        ...
        validationSchema: yup.object({
            name: yup.string().required("Please enter your name!").trim().min(2, "Name too short!"),
            email: yup.string().required("Please enter your email!").email("Invalid email! Email should have format: (ABC@gmail.com)."),
            phoneNumber: yup
                .string()
    ...
    return (
        <>
            <div className="pxs-5 mx-auto " id="updateForm">
                <Typography style={{ margin: theme.spacing(2, 0, 3, 0), textAlign: "center" }} component="h3" variant="h5">
                    Update User Profile
                </Typography>
